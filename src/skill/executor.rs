...
use crate::llm::{ChatMessage, registry::LLMRegistry};
use crate::skill::definition::{SkillContext, SkillDefinition, SkillStep};
...
impl SkillExecutor {
    ...
    fn render_template_string(&self, template: &str, ctx: &SkillContext) -> Result<String> {
        ...
        // Build steps array indexed by step_index
