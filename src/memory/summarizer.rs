...
mod tests {
    use super::*;
    use crate::llm::{FinishReason, LLMError, LLMFeature, LLMResponse};
    ...
    impl LLMProvider for MockLLMProvider {
        async fn complete(
            ...
            _config: Option<&crate::llm::LLMConfig>,
        ...
        async fn complete_stream(
            ...
            Box<
                dyn futures::Stream<Item = std::result::Result<crate::llm::LLMChunk, LLMError>>
                    + Unpin
                    + Send,
            >,
            LLMError,
